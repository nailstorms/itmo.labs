...
enum bmp_read_code_t read_picture(char const* filename, struct image* input_bmp)
{
...
enum bmp_write_code_t write_picture(char const* filename, struct image const* out_bmp)
{
